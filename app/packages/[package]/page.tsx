...
const data = {
  ...
  'large-party': { title:'Large Party', image:'/images/parties/party-beach.webp', secondary:'/images/parties/party-birthday.webp', intro:'More space for bigger guest lists, better flow and a proper party atmosphere.', size:'28ft × 38ft', capacity:'Standing room for 100', price:'£587', includes:['28ft × 38ft Capri marquee','Standing room for 100','Twinkle lights','Plain + clear side walls'], ideal:'Large birthdays, celebrations, drinks-led events and bigger garden parties.' },
  '45-guests': { title:'45 Guests', image:'/images/weddings/wedding-countryside.webp', secondary:'/images/weddings/wedding-castle.webp', intro:'A ready-made seated setup for events where dining and guest comfort matter.', size:'20ft × 30ft', capacity:'Up to 45 seated', price:'£1,035', includes:['20ft × 30ft Capri marquee','6 × 4ft round tables','2 × trestle tables','45 chairs','Dandydura matting','Plain + clear side walls'], ideal:'Smaller weddings, seated parties and private dining events.' },
